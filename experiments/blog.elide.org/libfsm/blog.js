...
/* TODO: do want to keep this separate from the real comments, for visual emphasis that it does not exist yet. then refresh when the ajax is submitted */
	var div;
		div = document.getElementById('comment-preview');


/* TODO: if sanity-check fails, show an error which goes where the normal form error is.
two kinds of error: 1. does not parse
2. contains dissalowed elements
(permit entity references)
permit CDATA
...
/* TODO: comment needs to be parsed... but then it is from validation, anyway */
		...
		xreplacechild(div.parentNode, t, div);
